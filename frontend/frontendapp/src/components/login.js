...
class Login extends Component
{
    ...
    login = event => {
        ...
        .then(
            data => {
                this.props.user_log(data.token);
            }
    ...
    render()
    {
        return (
            ...
            <br/>
            <button onClick={ this.login } style={{ margin: 20 + 'px' }} >Login </button>
            <button onClick={ this.register} style={{ margin: 20 + 'px' }} >Register </button>
